...
<%
    try{
        ...
        if(request.getParameter("btnnext")!=null)
        {
            ...
            out.println("hello averyone");
            PreparedStatement ps=conn.prepareStatement("insert into educational_details(examrollno,tenmarks,twemarks,photo)values(?,?,?,?)"); 
            out.println("hello edgdryone");
            ps.setInt(1,roll);
            ps.setInt(3,num);
            ps.setInt(4,num1);
            ps.setBinaryStream(5,fis,(int)file.length());
            out.println("hello anyone");
