<%-- 
    Document   : update1
    Created on : 5 Mar, 2020, 6:51:35 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        <form name="f7" method="POST">
                <table>
            <tr><td><label>Enter the username</label>
            </td>
        ...
        Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/Pro","pro","pro");
              ...
              
            {
                ...
                int x=stmt2.executeUpdate("Update selected_students set username='"+username+"' where examrollno="+examroll+" ");
                if(x>0)
                {   
