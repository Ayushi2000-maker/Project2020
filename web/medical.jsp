...
<div class="register">
 ...
 <input type="number" name="mnum" id="height" placeholder="Enter your Height" min="100" max="230" required><br><br>
            <label>Weight(in Kg)</label><br>
            <input type="number" name="mnum1" id="weight" placeholder="Enter your Weight" min="25" max="150" required><br><br>
            ...
            <input type="submit" name="btnprev" value="Previous" id="butt">
